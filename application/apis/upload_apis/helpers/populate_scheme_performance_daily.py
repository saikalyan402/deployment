...
def populate_perf(current_dir,new_date,first_col):
    ...
    for i in All_Debt_files:
        if i!='MasterSheet.csv':
            ...
            for j in range(df.shape[0]):
                if df.iloc[j][0]=='Scheme Name':
                    start_idx = j
                if df.iloc[j][0]=='Minimum':
                    end_idx = j
            # print(start_idx)
            # print(end_idx)
            
            df = pd.read_csv(current_dir+"/default/Schemes/Debt/"+str(i),header=start_idx+1,nrows=end_idx-start_idx-2)
    ...
    for i in All_Equity_files:
        if i!='MasterSheet.csv':
            ...
            # print(start_idx)
            # print(end_idx)
            df = pd.read_csv(current_dir+"/default/Schemes/Equity/"+str(i),header=start_idx+1,nrows=end_idx-start_idx-2)
            # df.columns = df.iloc[1].values
            # if 'Source :- ICRA Analytics Limited' in list(df.iloc[df.shape[0]-3]):
            #     df.columns = df.iloc[4].values
            #     df = df.iloc[5:df.shape[0]-11]
    ...
    for i in All_Debt_files:
        if i!='MasterSheet.csv':
            ...
            # print(start_idx)
            # print(end_idx)
            df = pd.read_csv(current_dir+"/undefault/Schemes/Debt/"+str(i),header=start_idx+1,nrows=end_idx-start_idx-2)
            # df.columns = df.iloc[1].values
            # if 'Source :- ICRA Analytics Limited' in list(df.iloc[df.shape[0]-3]):
            #     df.columns = df.iloc[4].values
            #     df = df.iloc[5:df.shape[0]-11]
    ...
    for i in All_Equity_files:
        if i!='MasterSheet.csv':
            ...
            # print(start_idx)
            # print(end_idx)
            df = pd.read_csv(current_dir+"/undefault/Schemes/Equity/"+str(i),header=start_idx+1,nrows=end_idx-start_idx-2)
            # df.columns = df.iloc[1].values
            # if 'Source :- ICRA Analytics Limited' in list(df.iloc[df.shape[0]-3]):
            #     df.columns = df.iloc[4].values
            #     df = df.iloc[5:df.shape[0]-11]
